...
**Before:** The "Before" chart is the boxplot already shown in Part 2 Q2 above. Since the only difference between the before and after versions is the fill palette — the data, geometry, axis labels, and layout are identical — reproducing the entire chart a second time here would just add noise to the document without aiding the comparison. Scroll up to Part 2 Q2 to see the original rainbow palette in context.
